...
namespace otf_gc
{
  namespace impl_details
  {
    ...
    static constexpr size_t log_ptr_size = sizeof(log_ptr_t);
    static constexpr size_t log_ptr_offset = 2*sizeof(size_t) + 2*sizeof(void*);
    static constexpr size_t search_depth = 64;
